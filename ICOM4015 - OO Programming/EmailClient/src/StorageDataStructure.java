...
public interface StorageDataStructure<E> {
	 ...
	 * @param file The String array containing a storage EmailContact object.
	 * @return True if the String array contained a proper storage EmailContact object, false otherwise.
	 */
