...
public class EmailClientWindow extends JPanel implements ListSelectionListener, MouseListener {
	...
	private class ToolBarListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if(temp.getText().equals("Send Email")) {
				...
				showNewEmailWindow(selectedContact.getContactEmail());
	...
	public void showContactWindow(EmailContact contact, int type, String key) {
		...
		if (type == 0) {
			...
			f1.setText(contact.getContactName());
			f2.setText(contact.getContactEmail());
			f3.setText(contact.getContactPhoneNumber());
			f4.setText(contact.getContactAddress());
			f5.setText(contact.getContactNote());
		}
	...
	public void showViewEmailWindow(Message message) {
		...
		try {
			viewer.setText(emailStorage.getText(message));
		} catch (IOException e) {
			e.printStackTrace();
		} catch (MessagingException e) {
			e.printStackTrace();
